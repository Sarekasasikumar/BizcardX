...
def setting_bg():
    st.markdown(f""" <style>.stApp {{
                        background: url("https://webgradients.com/public/webgradients_png/003%20Spring%20Warmth.png");
...
selected = option_menu(None, ["Home","Upload & Extract","Modify"], 
                       ...
                       styles={"nav-link": {"font-size": "35px", "text-align": "centre", "margin": "0px", "--hover-color": "#96E7C7"},
                               "icon": {"font-size": "35px"},
                               "container" : {"max-width": "6000px"},
                               "nav-link-selected": {"background-color": "#96E7C7"}})
